...
const file_config_proto_rawDesc = "" +
	"\n" +
	"\fconfig.proto\x12\n" +
	"v2ray.core\x1a!common/serial/typed_message.proto\x1a\x1dtransport/global/config.proto\"\xd0\x02\n" +
	"\x06Config\x12:\n" +
	"\ainbound\x18\x01 \x03(\v2 .v2ray.core.InboundHandlerConfigR\ainbound\x12=\n" +
	"\boutbound\x18\x02 \x03(\v2!.v2ray.core.OutboundHandlerConfigR\boutbound\x128\n" +
	"\x03app\x18\x04 \x03(\v2&.v2ray.core.common.serial.TypedMessageR\x03app\x12E\n" +
	"\ttransport\x18\x05 \x01(\v2#.v2ray.core.transport.global.ConfigB\x02\x18\x01R\ttransport\x12D\n" +
	"\textension\x18\x06 \x03(\v2&.v2ray.core.common.serial.TypedMessageR\textensionJ\x04\b\x03\x10\x04\"\xcc\x01\n" +
	...
	"\x0eproxy_settings\x18\x03 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\rproxySettings\"\xfb\x01\n" +
	"\x15OutboundHandlerConfig\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\tR\x03tag\x12O\n" +
	"\x0fsender_settings\x18\x02 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\x0esenderSettings\x12M\n" +
	"\x0eproxy_settings\x18\x03 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\rproxySettings\x12\x16\n" +
	"\x06expire\x18\x04 \x01(\x03R\x06expire\x12\x18\n" +
	"\acomment\x18\x05 \x01(\tR\acommentBD\n" +
	"\x0ecom.v2ray.coreP\x01Z#github.com/v2fly/v2ray-core/v4;core\xaa\x02\n" +
