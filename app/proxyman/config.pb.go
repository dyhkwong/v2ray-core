...
const file_app_proxyman_config_proto_rawDesc = "" +
	"\n" +
	"\x19app/proxyman/config.proto\x12\x17v2ray.core.app.proxyman\x1a\x18common/net/address.proto\x1a\x15common/net/port.proto\x1a\x1ftransport/internet/config.proto\x1a!common/serial/typed_message.proto\x1a\"common/net/packetaddr/config.proto\"\x0f\n" +
	...
	"\x11sniffing_settings\x18\b \x01(\v2'.v2ray.core.app.proxyman.SniffingConfigR\x10sniffingSettingsJ\x04\b\x06\x10\a\"\xcc\x01\n" +
	"\x14InboundHandlerConfig\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\tR\x03tag\x12S\n" +
	"\x11receiver_settings\x18\x02 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\x10receiverSettings\x12M\n" +
	"\x0eproxy_settings\x18\x03 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\rproxySettings\"\x10\n" +
	...
	"\x03TLS\x10\x01Bf\n" +
	"\x1bcom.v2ray.core.app.proxymanP\x01Z+github.com/v2fly/v2ray-core/v4/app/proxyman\xaa\x02\x17V2Ray.Core.App.Proxymanb\x06proto3"
