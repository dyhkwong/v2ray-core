...
const file_app_proxyman_command_command_proto_rawDesc = "" +
	"\n" +
	"\"app/proxyman/command/command.proto\x12\x1fv2ray.core.app.proxyman.command\x1a\x1acommon/protocol/user.proto\x1a!common/serial/typed_message.proto\x1a\fconfig.proto\"H\n" +
	...
	"\x15RemoveInboundResponse\"m\n" +
	"\x13AlterInboundRequest\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\tR\x03tag\x12D\n" +
	"\toperation\x18\x02 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\toperation\"\x16\n" +
	...
	"\x16RemoveOutboundResponse\"n\n" +
	"\x14AlterOutboundRequest\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\tR\x03tag\x12D\n" +
	"\toperation\x18\x02 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\toperation\"\x17\n" +
