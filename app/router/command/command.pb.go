...
const file_app_router_command_command_proto_rawDesc = "" +
	"\n" +
	" app/router/command/command.proto\x12\x1dv2ray.core.app.router.command\x1a\x18common/net/network.proto\"\xa8\x04\n" +
	...
	"\rPublishResult\x18\x03 \x01(\bR\rPublishResult\"9\n" +
	"\x13GetBalancersRequest\x12\"\n" +
	"\fbalancerTags\x18\x01 \x03(\tR\fbalancerTags\"'\n" +
