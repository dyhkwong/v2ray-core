...
const file_app_router_config_proto_rawDesc = "" +
	"\n" +
	"\x17app/router/config.proto\x12\x15v2ray.core.app.router\x1a\x19google/protobuf/any.proto\x1a\x15common/net/port.proto\x1a\x18common/net/network.proto\x1a\x14common/net/uid.proto\x1a common/protoext/extensions.proto\x1a$app/router/routercommon/common.proto\"\xa5\t\n" +
	...
	"\fnetwork_type\x18\x14 \x01(\tR\vnetworkType\x12\x1f\n" +
	...
	"\x0ebalancing_rule\x18\x03 \x03(\v2$.v2ray.core.app.router.BalancingRuleR\rbalancingRule\"\xd0\x06\n" +
