...
const file_app_tun_config_proto_rawDesc = "" +
	"\n" +
	"\x14app/tun/config.proto\x12\x12v2ray.core.app.tun\x1a\x19app/proxyman/config.proto\x1a\x17app/router/config.proto\x1a\"common/net/packetaddr/config.proto\x1a\x1ftransport/internet/config.proto\"\xa4\x04\n" +
	"\x06Config\x12\x12\n" +
	...
	"\x11sniffing_settings\x18\v \x01(\v2'.v2ray.core.app.proxyman.SniffingConfigR\x10sniffingSettingsBW\n" +
	"\x16com.v2ray.core.app.tunP\x01Z&github.com/v2fly/v2ray-core/v4/app/tun\xaa\x02\x12V2Ray.Core.App.Tunb\x06proto3"
