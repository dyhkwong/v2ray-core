...
const file_app_persistentstorage_filesystemstorage_config_proto_rawDesc = "" +
	"\n" +
	"4app/persistentstorage/filesystemstorage/config.proto\x122v2ray.core.app.persistentstorage.filesystemstorage\"\xbf\x01\n" +
	"\x06Config\x12r\n" +
	...
	"\tprotojson\x18\x05 \x01(\bR\tprotojson*\x1f\n" +
	"\x10StateStorageRoot\x12\v\n" +
	"\aWorkDir\x10\x00B\xb3\x01\n" +
	"2com.v2ray.core.persistentstorage.filesystemstorageP\x01ZFgithub.com/v2fly/v2ray-core/v4/app/persistentstorage/filesystemstorage\xaa\x022V2Ray.Core.App.Persistentstorage.Filesystemstorageb\x06proto3"
