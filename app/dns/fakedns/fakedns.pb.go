...
const file_app_dns_fakedns_fakedns_proto_rawDesc = "" +
	"\n" +
	"\x1dapp/dns/fakedns/fakedns.proto\x12\x1av2ray.core.app.dns.fakedns\"@\n" +
	"\vFakeDnsPool\x12\x17\n" +
	"\aip_pool\x18\x01 \x01(\tR\x06ipPool\x12\x18\n" +
	"\alruSize\x18\x02 \x01(\x03R\alruSize\"Q\n" +
	"\x10FakeDnsPoolMulti\x12=\n" +
	"\x05pools\x18\x01 \x03(\v2'.v2ray.core.app.dns.fakedns.FakeDnsPoolR\x05poolsBo\n" +
	"\x1ecom.v2ray.core.app.dns.fakednsP\x01Z.github.com/v2fly/v2ray-core/v4/app/dns/fakedns\xaa\x02\x1aV2Ray.Core.App.Dns.Fakednsb\x06proto3"
