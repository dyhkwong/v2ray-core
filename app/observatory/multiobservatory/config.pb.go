...
const file_app_observatory_multiobservatory_config_proto_rawDesc = "" +
	"\n" +
	"-app/observatory/multiobservatory/config.proto\x12+v2ray.core.app.observatory.multiObservatory\x1a$common/taggedfeatures/skeleton.proto\"L\n" +
	"\x06Config\x12B\n" +
	"\aholders\x18\x01 \x01(\v2(.v2ray.core.common.taggedfeatures.ConfigR\aholdersB\xa2\x01\n" +
	"/com.v2ray.core.app.observatory.multiObservatoryP\x01Z?github.com/v2fly/v2ray-core/v4/app/observatory/multiobservatory\xaa\x02+V2Ray.Core.App.Observatory.MultiObservatoryb\x06proto3"
