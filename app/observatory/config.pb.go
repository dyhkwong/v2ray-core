...
const file_app_observatory_config_proto_rawDesc = "" +
	"\n" +
	"\x1capp/observatory/config.proto\x12\x1av2ray.core.app.observatory\"W\n" +
	...
	"\tIntensity\x12%\n" +
	"\x0eprobe_interval\x18\x01 \x01(\rR\rprobeInterval\"\xaf\x01\n" +
	"\x06Config\x12)\n" +
	...
	"\x17persistent_probe_result\x18\x05 \x01(\bR\x15persistentProbeResultBo\n" +
	"\x1ecom.v2ray.core.app.observatoryP\x01Z.github.com/v2fly/v2ray-core/v4/app/observatory\xaa\x02\x1aV2Ray.Core.App.Observatoryb\x06proto3"
