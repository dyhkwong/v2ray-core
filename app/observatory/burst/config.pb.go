...
const file_app_observatory_burst_config_proto_rawDesc = "" +
	"\n" +
	"\"app/observatory/burst/config.proto\x12 v2ray.core.app.observatory.burst\"\x88\x01\n" +
	"\x06Config\x12)\n" +
	...
	"$com.v2ray.core.app.observatory.burstP\x01Z4github.com/v2fly/v2ray-core/v4/app/observatory/burst\xaa\x02 V2Ray.Core.App.Observatory.Burstb\x06proto3"
