...
const file_app_observatory_command_command_proto_rawDesc = "" +
	"\n" +
	"%app/observatory/command/command.proto\x12\"v2ray.core.app.observatory.command\x1a\x1capp/observatory/config.proto\",\n" +
	"\x18GetOutboundStatusRequest\x12\x10\n" +
	"\x03Tag\x18\x01 \x01(\tR\x03Tag\"b\n" +
	"\x19GetOutboundStatusResponse\x12E\n" +
	"\x06status\x18\x01 \x01(\v2-.v2ray.core.app.observatory.ObservationResultR\x06status\"\b\n" +
	"\x06Config2\xa9\x01\n" +
