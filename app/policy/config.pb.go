...
const file_app_policy_config_proto_rawDesc = "" +
	"\n" +
	"\x17app/policy/config.proto\x12\x15v2ray.core.app.policy\"\x1e\n" +
	"\x06Second\x12\x14\n" +
	...
	"\x11outbound_downlink\x18\x04 \x01(\bR\x10outboundDownlink\"\xde\x01\n" +
	"\x06Config\x12>\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x1d.v2ray.core.app.policy.PolicyR\x05value:\x028\x01B`\n" +
	"\x19com.v2ray.core.app.policyP\x01Z)github.com/v2fly/v2ray-core/v4/app/policy\xaa\x02\x15V2Ray.Core.App.Policyb\x06proto3"
