...
const file_app_stats_config_proto_rawDesc = "" +
	"\n" +
	"\x16app/stats/config.proto\x12\x14v2ray.core.app.stats\"\b\n" +
	"\x06Config\"u\n" +
	...
	"BufferSizeB]\n" +
	"\x18com.v2ray.core.app.statsP\x01Z(github.com/v2fly/v2ray-core/v4/app/stats\xaa\x02\x14V2Ray.Core.App.Statsb\x06proto3"
