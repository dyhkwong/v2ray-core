...
type ClientConfig struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	RoundTripperClient *serial.TypedMessage   `protobuf:"bytes,1,opt,name=round_tripper_client,json=roundTripperClient,proto3" json:"round_tripper_client,omitempty"`
...
func (x *ClientConfig) GetRoundTripperClient() *serial.TypedMessage {
	if x != nil {
...
func (x *ClientConfig) GetSecurityConfig() *serial.TypedMessage {
	if x != nil {
...
func (x *ServerInverseRoleConfig) GetRoundTripperClient() *serial.TypedMessage {
	if x != nil {
		return x.RoundTripperClient
	}
	return nil
...
func (x *ServerInverseRoleConfig) GetSecurityConfig() *serial.TypedMessage {
	if x != nil {
		return x.SecurityConfig
	}
	return nil
...
type Acceptor struct {
	...
	ServerConfig         *serial.TypedMessage        `protobuf:"bytes,1,opt,name=server_config,json=serverConfig,proto3" json:"server_config,omitempty"`
...
func (x *Acceptor) GetServerConfig() *serial.TypedMessage {
	if x != nil {
...
type Remote struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tag           string                 `protobuf:"bytes,3,opt,name=tag,proto3" json:"tag,omitempty"`
	ClientConfig  *serial.TypedMessage   `protobuf:"bytes,1,opt,name=client_config,json=clientConfig,proto3" json:"client_config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Remote) GetClientConfig() *serial.TypedMessage {
	if x != nil {
...
const file_app_webrtc_config_proto_rawDesc = "" +
	"\n" +
	"\x17app/webrtc/config.proto\x12\x15v2ray.core.app.webrtc\x1a\"common/net/packetaddr/config.proto\x1a!common/serial/typed_message.proto\"\\\n" +
	...
	"Qrequire_remote_finish_candidate_gathering_before_sending_own_candidate_workaround\x18\v \x01(\bRHrequireRemoteFinishCandidateGatheringBeforeSendingOwnCandidateWorkaround\"\x8d\x02\n" +
	...
	"\x14request_port_blossom\x18\a \x01(\bR\x12requestPortBlossom\x12.\n" +
	"\x13accept_port_blossom\x18\b \x01(\bR\x11acceptPortBlossom\x129\n" +
	"\x19port_blossom_duration_sec\x18\t \x01(\rR\x16portBlossomDurationSec\"\x99\x02\n" +
	"\fClientConfig\x12X\n" +
	...
	"\x0fserver_identity\x18\x05 \x01(\fR\x0eserverIdentity\"\xa4\x02\n" +
	"\x17ServerInverseRoleConfig\x12X\n" +
	"\x14round_tripper_client\x18\x01 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\x12roundTripperClient\x12O\n" +
	"\x0fsecurity_config\x18\x02 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\x0esecurityConfig\x12\x12\n" +
	"\x04dest\x18\x03 \x01(\tR\x04dest\x12!\n" +
	"\foutbound_tag\x18\x04 \x01(\tR\voutboundTag\x12'\n" +
	"\x0fserver_identity\x18\x05 \x01(\fR\x0eserverIdentity\"q\n" +
	...
	"\x11accept_connect_on\x18\x04 \x01(\tR\x0facceptConnectOn\"\xf4\x01\n" +
	"\bAcceptor\x12\x10\n" +
	"\x03tag\x18\x03 \x01(\tR\x03tag\x12K\n" +
	"\rserver_config\x18\x01 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\fserverConfig\x12e\n" +
	"\x16port_forwarder_accepts\x18\x02 \x03(\v2/.v2ray.core.app.webrtc.UDPPortForwarderAcceptorR\x14portForwarderAccepts\x12\"\n" +
	"\raccept_on_tag\x18\x04 \x01(\tR\vacceptOnTag\"g\n" +
	"\x06Remote\x12\x10\n" +
	"\x03tag\x18\x03 \x01(\tR\x03tag\x12K\n" +
	"\rclient_config\x18\x01 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\fclientConfig\"\xb2\x01\n" +
	...
	"\fport_forward\x18\x03 \x03(\v2-.v2ray.core.app.webrtc.UDPPortForwarderRemoteR\vportForward\"\xed\x02\n" +
	"\x06Config\x12F\n" +
	...
	"connectionB`\n" +
	"\x19com.v2ray.core.app.webrtcP\x01Z)github.com/v2fly/v2ray-core/v4/app/webrtc\xaa\x02\x15V2Ray.Core.App.WebRTCb\x06proto3"
...
var file_app_webrtc_config_proto_goTypes = []any{
	...
	(*serial.TypedMessage)(nil),       // 12: v2ray.core.common.serial.TypedMessage
}
var file_app_webrtc_config_proto_depIdxs = []int32{
	...
	12, // 2: v2ray.core.app.webrtc.ClientConfig.round_tripper_client:type_name -> v2ray.core.common.serial.TypedMessage
	12, // 3: v2ray.core.app.webrtc.ClientConfig.security_config:type_name -> v2ray.core.common.serial.TypedMessage
	12, // 4: v2ray.core.app.webrtc.ServerInverseRoleConfig.round_tripper_client:type_name -> v2ray.core.common.serial.TypedMessage
	12, // 5: v2ray.core.app.webrtc.ServerInverseRoleConfig.security_config:type_name -> v2ray.core.common.serial.TypedMessage
	12, // 6: v2ray.core.app.webrtc.Acceptor.server_config:type_name -> v2ray.core.common.serial.TypedMessage
	5,  // 7: v2ray.core.app.webrtc.Acceptor.port_forwarder_accepts:type_name -> v2ray.core.app.webrtc.UDPPortForwarderAcceptor
	12, // 8: v2ray.core.app.webrtc.Remote.client_config:type_name -> v2ray.core.common.serial.TypedMessage
