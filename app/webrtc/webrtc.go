...
import (
	...
	cbuf "github.com/v2fly/v2ray-core/v4/common/buf"
	v2errors "github.com/v2fly/v2ray-core/v4/common/errors"
	v2net "github.com/v2fly/v2ray-core/v4/common/net"
	"github.com/v2fly/v2ray-core/v4/common/serial"
	"github.com/v2fly/v2ray-core/v4/common/session"
	featuredns "github.com/v2fly/v2ray-core/v4/features/dns"
...
func decodeClientConfig(raw *serial.TypedMessage) (*ClientConfig, error) {
	if raw == nil {
		return nil, newError("missing remote client_config")
	}
	instance, err := raw.GetInstance()
	if err != nil {
...
func decodeServerConfig(raw *serial.TypedMessage) (*ServerInverseRoleConfig, error) {
	if raw == nil {
