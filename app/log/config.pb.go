...
const file_app_log_config_proto_rawDesc = "" +
	"\n" +
	"\x14app/log/config.proto\x12\x12v2ray.core.app.log\x1a\x14common/log/log.proto\"\xa7\x02\n" +
	"\x06Config\x12A\n" +
	"\x0eerror_log_type\x18\x01 \x01(\x0e2\x1b.v2ray.core.app.log.LogTypeR\ferrorLogType\x12G\n" +
	"\x0ferror_log_level\x18\x02 \x01(\x0e2\x1f.v2ray.core.common.log.SeverityR\rerrorLogLevel\x12$\n" +
	"\x0eerror_log_path\x18\x03 \x01(\tR\ferrorLogPath\x12C\n" +
	"\x0faccess_log_type\x18\x04 \x01(\x0e2\x1b.v2ray.core.app.log.LogTypeR\raccessLogType\x12&\n" +
	"\x0faccess_log_path\x18\x05 \x01(\tR\raccessLogPath*5\n" +
	"\aLogType\x12\b\n" +
	"\x04None\x10\x00\x12\v\n" +
	"\aConsole\x10\x01\x12\b\n" +
	"\x04File\x10\x02\x12\t\n" +
	"\x05Event\x10\x03BW\n" +
	"\x16com.v2ray.core.app.logP\x01Z&github.com/v2fly/v2ray-core/v4/app/log\xaa\x02\x12V2Ray.Core.App.Logb\x06proto3"
