...
const file_proxy_vlite_inbound_config_proto_rawDesc = "" +
	"\n" +
	" proxy/vlite/inbound/config.proto\x12\x1ev2ray.core.proxy.vlite.inbound\"\xa2\x02\n" +
	...
	"\"com.v2ray.core.proxy.vlite.inboundP\x01Z2github.com/v2fly/v2ray-core/v4/proxy/vlite/inbound\xaa\x02\x1eV2Ray.Core.Proxy.Vlite.Inboundb\x06proto3"
