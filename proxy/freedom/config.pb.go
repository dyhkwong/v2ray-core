...
const file_proxy_freedom_config_proto_rawDesc = "" +
	"\n" +
	"\x1aproxy/freedom/config.proto\x12\x18v2ray.core.proxy.freedom\x1a!common/protocol/server_spec.proto\"Y\n" +
	...
	"\n" +
	"PREFER_IP6\x10\x05*A\n" +
	"\x13ProtocolReplacement\x12\f\n" +
	"\bIDENTITY\x10\x00\x12\r\n" +
	"\tFORCE_TCP\x10\x01\x12\r\n" +
	"\tFORCE_UDP\x10\x02Bi\n" +
	"\x1ccom.v2ray.core.proxy.freedomP\x01Z,github.com/v2fly/v2ray-core/v4/proxy/freedom\xaa\x02\x18V2Ray.Core.Proxy.Freedomb\x06proto3"
