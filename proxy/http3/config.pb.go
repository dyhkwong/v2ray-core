...
const file_proxy_http3_config_proto_rawDesc = "" +
	"\n" +
	"\x18proxy/http3/config.proto\x12\x16v2ray.core.proxy.http3\x1a\x18common/net/address.proto\x1a#transport/internet/tls/config.proto\"\x84\x03\n" +
	"\fClientConfig\x12;\n" +
	...
	"\x1acom.v2ray.core.proxy.http3P\x01Z*github.com/v2fly/v2ray-core/v4/proxy/http3\xaa\x02\x16V2Ray.Core.Proxy.Http3b\x06proto3"
