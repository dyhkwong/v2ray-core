...
var file_proxy_http3_config_proto_rawDesc = []byte{
...
var (
	...
	file_proxy_http3_config_proto_rawDescData = file_proxy_http3_config_proto_rawDesc
)

func file_proxy_http3_config_proto_rawDescGZIP() []byte {
	file_proxy_http3_config_proto_rawDescOnce.Do(func() {
		file_proxy_http3_config_proto_rawDescData = protoimpl.X.CompressGZIP(file_proxy_http3_config_proto_rawDescData)
	})
...
func file_proxy_http3_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proxy_http3_config_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_proxy_http3_config_proto_rawDesc = nil
