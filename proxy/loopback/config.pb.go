...
const file_proxy_loopback_config_proto_rawDesc = "" +
	"\n" +
	"\x1bproxy/loopback/config.proto\x12\x19v2ray.core.proxy.loopback\")\n" +
	"\x06Config\x12\x1f\n" +
	"\vinbound_tag\x18\x01 \x01(\tR\n" +
	"inboundTagBl\n" +
	"\x1dcom.v2ray.core.proxy.loopbackP\x01Z-github.com/v2fly/v2ray-core/v4/proxy/loopback\xaa\x02\x19V2Ray.Core.Proxy.Loopbackb\x06proto3"
