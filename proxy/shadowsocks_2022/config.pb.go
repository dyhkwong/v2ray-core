...
const file_proxy_shadowsocks_2022_config_proto_rawDesc = "" +
	"\n" +
	"#proxy/shadowsocks_2022/config.proto\x12!v2ray.core.proxy.shadowsocks_2022\x1a\x18common/net/network.proto\x1a\x18common/net/address.proto\"\x9e\x01\n" +
	"\fServerConfig\x12\x16\n" +
	"\x06method\x18\x01 \x01(\tR\x06method\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12\x14\n" +
	"\x05level\x18\x04 \x01(\x05R\x05level\x128\n" +
	"\anetwork\x18\x05 \x03(\x0e2\x1e.v2ray.core.common.net.NetworkR\anetwork\"\xba\x01\n" +
	"\x15MultiUserServerConfig\x12\x16\n" +
	"\x06method\x18\x01 \x01(\tR\x06method\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12=\n" +
	"\x05users\x18\x03 \x03(\v2'.v2ray.core.proxy.shadowsocks_2022.UserR\x05users\x128\n" +
	"\anetwork\x18\x04 \x03(\x0e2\x1e.v2ray.core.common.net.NetworkR\anetwork\"\xa1\x01\n" +
	...
	"\anetwork\x18\x04 \x03(\x0e2\x1e.v2ray.core.common.net.NetworkR\anetwork\"D\n" +
	"\x04User\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12\x14\n" +
	"\x05level\x18\x03 \x01(\x05R\x05level\"\x89\x01\n" +
	"\fClientConfig\x12;\n" +
	...
	"\x03key\x18\x04 \x01(\tR\x03keyB\x84\x01\n" +
	"%com.v2ray.core.proxy.shadowsocks_2022P\x01Z5github.com/v2fly/v2ray-core/v4/proxy/shadowsocks_2022\xaa\x02!V2Ray.Core.Proxy.Shadowsocks_2022b\x06proto3"
