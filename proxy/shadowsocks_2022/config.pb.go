...
const file_proxy_shadowsocks_2022_config_proto_rawDesc = "" +
	"\n" +
	"#proxy/shadowsocks_2022/config.proto\x12!v2ray.core.proxy.shadowsocks_2022\x1a common/protoext/extensions.proto\x1a\x18common/net/network.proto\x1a\x18common/net/address.proto\"\x99\x02\n" +
	...
	"\ainbound\x12\x10shadowsocks-2022\"\xbb\x02\n" +
	...
	"\x05level\x18\x05 \x01(\x05R\x05level\"\xd1\x02\n" +
	...
	"\x05level\x18\x03 \x01(\x05R\x05level\"\x85\x02\n" +
	"\fClientConfig\x12;\n" +
