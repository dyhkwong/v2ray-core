...
const file_proxy_wireguard_wgcommon_config_proto_rawDesc = "" +
	...
	"'com.v2ray.core.proxy.wireguard.wgcommonP\x01Z7github.com/v2fly/v2ray-core/v4/proxy/wireguard/wgcommon\xaa\x02#V2Ray.Core.Proxy.Wireguard.Wgcommonb\x06proto3"
