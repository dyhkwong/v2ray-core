...
const file_proxy_wireguard_outbound_config_proto_rawDesc = "" +
	"\n" +
	"%proxy/wireguard/outbound/config.proto\x12#v2ray.core.proxy.wireguard.outbound\x1a%proxy/wireguard/wgcommon/config.proto\x1a,common/packetswitch/gvisorstack/config.proto\"\x83\x03\n" +
	"\x06Config\x12N\n" +
