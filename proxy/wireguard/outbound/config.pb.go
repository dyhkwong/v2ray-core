...
import (
	_ "github.com/v2fly/v2ray-core/v4/common/net/packetaddr"
	gvisorstack "github.com/v2fly/v2ray-core/v4/common/packetswitch/gvisorstack"
	wgcommon "github.com/v2fly/v2ray-core/v4/proxy/wireguard/wgcommon"
...
const file_proxy_wireguard_outbound_config_proto_rawDesc = "" +
	"\n" +
	"%proxy/wireguard/outbound/config.proto\x12#v2ray.core.proxy.wireguard.outbound\x1a%proxy/wireguard/wgcommon/config.proto\x1a,common/packetswitch/gvisorstack/config.proto\x1a\"common/net/packetaddr/config.proto\"\x83\x03\n" +
	"\x06Config\x12N\n" +
	...
	"\aUSE_IP6\x10\x03B\x8a\x01\n" +
	"'com.v2ray.core.proxy.wireguard.outboundP\x01Z7github.com/v2fly/v2ray-core/v4/proxy/wireguard/outbound\xaa\x02#V2Ray.Core.Proxy.Wireguard.Outboundb\x06proto3"
