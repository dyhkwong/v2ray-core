...
const file_proxy_dokodemo_config_proto_rawDesc = "" +
	"\n" +
	"\x1bproxy/dokodemo/config.proto\x12\x19v2ray.core.proxy.dokodemo\x1a\x18common/net/address.proto\x1a\x18common/net/network.proto\"\xc6\x02\n" +
	"\x06Config\x12;\n" +
	...
	"\n" +
	"user_level\x18\x06 \x01(\rR\tuserLevelBl\n" +
	"\x1dcom.v2ray.core.proxy.dokodemoP\x01Z-github.com/v2fly/v2ray-core/v4/proxy/dokodemo\xaa\x02\x19V2Ray.Core.Proxy.Dokodemob\x06proto3"
