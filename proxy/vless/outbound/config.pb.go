...
const file_proxy_vless_outbound_config_proto_rawDesc = "" +
	"\n" +
	"!proxy/vless/outbound/config.proto\x12\x1fv2ray.core.proxy.vless.outbound\x1a!common/protocol/server_spec.proto\"J\n" +
	"\x06Config\x12@\n" +
	"\x05vnext\x18\x01 \x03(\v2*.v2ray.core.common.protocol.ServerEndpointR\x05vnextB~\n" +
