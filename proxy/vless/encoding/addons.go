...
func EncodeBodyAddons(writer io.Writer, request *protocol.RequestHeader, requestAddons *Addons, state *TrafficState, isUplink bool, context context.Context) buf.Writer {
