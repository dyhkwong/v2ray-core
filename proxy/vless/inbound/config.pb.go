...
const file_proxy_vless_inbound_config_proto_rawDesc = "" +
	"\n" +
	" proxy/vless/inbound/config.proto\x12\x1ev2ray.core.proxy.vless.inbound\x1a\x1acommon/protocol/user.proto\"\x82\x01\n" +
	"\bFallback\x12\x12\n" +
	...
	"decryption\x12F\n" +
	"\tfallbacks\x18\x03 \x03(\v2(.v2ray.core.proxy.vless.inbound.FallbackR\tfallbacksB{\n" +
