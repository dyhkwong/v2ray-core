...
const file_proxy_vmess_outbound_config_proto_rawDesc = "" +
	"\n" +
	"!proxy/vmess/outbound/config.proto\x12\x1fv2ray.core.proxy.vmess.outbound\x1a!common/protocol/server_spec.proto\x1a\"common/net/packetaddr/config.proto\"\xa4\x01\n" +
	"\x06Config\x12F\n" +
