...
const file_transport_internet_websocket_config_proto_rawDesc = "" +
	"\n" +
	")transport/internet/websocket/config.proto\x12'v2ray.core.transport.internet.websocket\"0\n" +
	"\x06Header\x12\x10\n" +
	...
	"\x16early_data_header_name\x18\a \x01(\tR\x13earlyDataHeaderNameJ\x04\b\x01\x10\x02B\x96\x01\n" +
