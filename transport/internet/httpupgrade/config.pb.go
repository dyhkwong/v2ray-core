...
const file_transport_internet_httpupgrade_config_proto_rawDesc = "" +
	"\n" +
	"+transport/internet/httpupgrade/config.proto\x121v2ray.core.transport.internet.request.httpupgrade\"0\n" +
	"\x06Header\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"\x91\x02\n" +
	"\x06Config\x12\x12\n" +
	...
	"\x15parse_x_forwarded_for\x18\x06 \x01(\bR\x12parseXForwardedForB\x9c\x01\n" +
	"-com.v2ray.core.transport.internet.httpupgradeP\x01Z=github.com/v2fly/v2ray-core/v4/transport/internet/httpupgrade\xaa\x02)V2Ray.Core.Transport.Internet.HttpUpgradeb\x06proto3"
