...
const file_transport_internet_dtls_config_proto_rawDesc = "" +
	"\n" +
	"$transport/internet/dtls/config.proto\x12\"v2ray.core.transport.internet.dtls\"\xa8\x01\n" +
	"\x06Config\x12@\n" +
	...
	"\x18replay_protection_window\x18\x04 \x01(\rR\x16replayProtectionWindow* \n" +
	"\bDTLSMode\x12\v\n" +
	"\aINVALID\x10\x00\x12\a\n" +
	"\x03PSK\x10\x01B\x87\x01\n" +
	"&com.v2ray.core.transport.internet.dtlsP\x01Z6github.com/v2fly/v2ray-core/v4/transport/internet/dtls\xaa\x02\"V2Ray.Core.Transport.Internet.Dtlsb\x06proto3"
