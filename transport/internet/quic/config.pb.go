...
const file_transport_internet_quic_config_proto_rawDesc = "" +
	"\n" +
	"$transport/internet/quic/config.proto\x12\"v2ray.core.transport.internet.quic\x1a!common/serial/typed_message.proto\x1a\x1dcommon/protocol/headers.proto\"\xa2\x01\n" +
	"\x06Config\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12F\n" +
	"\bsecurity\x18\x02 \x01(\v2*.v2ray.core.common.protocol.SecurityConfigR\bsecurity\x12>\n" +
	"\x06header\x18\x03 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\x06headerB\x87\x01\n" +
