...
import (
	...
	commonerrors "github.com/v2fly/v2ray-core/v4/common/errors"
	v2net "github.com/v2fly/v2ray-core/v4/common/net"
	"github.com/v2fly/v2ray-core/v4/transport/internet"
	transportdtls "github.com/v2fly/v2ray-core/v4/transport/internet/dtls"
	"github.com/v2fly/v2ray-core/v4/transport/internet/rrpit/packetToStream"
	"github.com/v2fly/v2ray-core/v4/transport/internet/rrpit/rriptMonoDirectionSession"
	"github.com/v2fly/v2ray-core/v4/transport/internet/rrpit/rrpitBidirectionalSession"
	"github.com/v2fly/v2ray-core/v4/transport/internet/rrpit/rrpitBidirectionalSessionManager"
	"github.com/v2fly/v2ray-core/v4/transport/internet/rrpit/rrpitChannelManager"
	"github.com/v2fly/v2ray-core/v4/transport/internet/rrpit/rrpitDebuger"
)
...
func resolveChannels(
	...
	for index, channel := range config.GetChannels() {
		...
		message, err := channel.GetChannel().GetInstance()
		if err != nil {
			return nil, err
		}
