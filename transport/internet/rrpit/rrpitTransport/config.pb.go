...
type Channel struct {
	...
	Channel       *serial.TypedMessage `protobuf:"bytes,2,opt,name=channel,proto3" json:"channel,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Channel) GetChannel() *serial.TypedMessage {
	if x != nil {
		return x.Channel
	}
	return nil
...
const file_transport_internet_rrpit_rrpitTransport_config_proto_rawDesc = "" +
	"\n" +
	"4transport/internet/rrpit/rrpitTransport/config.proto\x12-v2ray.core.transport.internet.rrpit.transport\x1a!common/serial/typed_message.proto\"\x8f\x01\n" +
	"\x0eDTLSUDPChannel\x12\x0e\n" +
	"\x02ip\x18\x01 \x01(\fR\x02ip\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12=\n" +
	"\x1bno_incoming_message_timeout\x18\x04 \x01(\x03R\x18noIncomingMessageTimeout\"\xa4\x01\n" +
	"\aChannel\x12W\n" +
	"\asetting\x18\x01 \x01(\v2=.v2ray.core.transport.internet.rrpit.transport.ChannelSettingR\asetting\x12@\n" +
	"\achannel\x18\x02 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\achannel\"f\n" +
	...
	"!remote_control_inactivity_timeout\x18\x05 \x01(\x03R\x1eremoteControlInactivityTimeout\"\x99\x05\n" +
	"\x06Config\x12R\n" +
	...
	"sessionMgr\x12m\n" +
	"\vpersistence\x18\a \x01(\v2K.v2ray.core.transport.internet.rrpit.transport.ConnectionPersistenceSettingR\vpersistenceB\xad\x01\n" +
	"1com.v2ray.core.transport.internet.rrpit.transportP\x01ZFgithub.com/v2fly/v2ray-core/v4/transport/internet/rrpit/rrpitTransport\xaa\x02-V2Ray.Core.Transport.Internet.Rrpit.Transportb\x06proto3"
...
var file_transport_internet_rrpit_rrpitTransport_config_proto_goTypes = []any{
	...
	(*serial.TypedMessage)(nil),          // 11: v2ray.core.common.serial.TypedMessage
}
var file_transport_internet_rrpit_rrpitTransport_config_proto_depIdxs = []int32{
	...
	11, // 1: v2ray.core.transport.internet.rrpit.transport.Channel.channel:type_name -> v2ray.core.common.serial.TypedMessage
