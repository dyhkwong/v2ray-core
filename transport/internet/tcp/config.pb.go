...
const file_transport_internet_tcp_config_proto_rawDesc = "" +
	"\n" +
	"#transport/internet/tcp/config.proto\x12!v2ray.core.transport.internet.tcp\x1a!common/serial/typed_message.proto\"\x93\x01\n" +
	"\x06Config\x12O\n" +
	"\x0fheader_settings\x18\x02 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\x0eheaderSettings\x122\n" +
	"\x15accept_proxy_protocol\x18\x03 \x01(\bR\x13acceptProxyProtocolJ\x04\b\x01\x10\x02B\x84\x01\n" +
