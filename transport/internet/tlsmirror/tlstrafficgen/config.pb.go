...
const file_transport_internet_tlsmirror_tlstrafficgen_config_proto_rawDesc = "" +
	"\n" +
	"7transport/internet/tlsmirror/tlstrafficgen/config.proto\x125v2ray.core.transport.internet.tlsmirror.tlstrafficgen\x1a!common/serial/typed_message.proto\"\x88\x01\n" +
	"\bTimeSpec\x12)\n" +
	...
	"\"h2_do_not_wait_for_download_finish\x18\f \x01(\bR\x1ch2DoNotWaitForDownloadFinish\"\xb0\x01\n" +
	"\x06Config\x12Q\n" +
...
var file_transport_internet_tlsmirror_tlstrafficgen_config_proto_depIdxs = []int32{
	...
	5, // 4: v2ray.core.transport.internet.tlsmirror.tlstrafficgen.Config.security_settings:type_name -> v2ray.core.common.serial.TypedMessage
