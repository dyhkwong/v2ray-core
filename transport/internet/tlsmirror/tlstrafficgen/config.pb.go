...
type Config struct {
	...
	SecuritySettings *serial.TypedMessage   `protobuf:"bytes,2,opt,name=security_settings,json=securitySettings,proto3" json:"security_settings,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *Config) GetSecuritySettings() *serial.TypedMessage {
	if x != nil {
...
const file_transport_internet_tlsmirror_tlstrafficgen_config_proto_rawDesc = "" +
	"\n" +
	"7transport/internet/tlsmirror/tlstrafficgen/config.proto\x125v2ray.core.transport.internet.tlsmirror.tlstrafficgen\x1a!common/serial/typed_message.proto\"J\n" +
	"\x06Header\x12\x12\n" +
	...
	" \x01(\bR\x14connectionRecallExit\"\xb0\x01\n" +
	"\x06Config\x12Q\n" +
	"\x05steps\x18\x01 \x03(\v2;.v2ray.core.transport.internet.tlsmirror.tlstrafficgen.StepR\x05steps\x12S\n" +
	"\x11security_settings\x18\x02 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\x10securitySettingsB\xc0\x01\n" +
	"9com.v2ray.core.transport.internet.tlsmirror.tlstrafficgenP\x01ZIgithub.com/v2fly/v2ray-core/v4/transport/internet/tlsmirror/tlstrafficgen\xaa\x025V2Ray.Core.Transport.Internet.Tlsmirror.Tlstrafficgenb\x06proto3"
...
var file_transport_internet_tlsmirror_tlstrafficgen_config_proto_goTypes = []any{
	...
	(*serial.TypedMessage)(nil), // 4: v2ray.core.common.serial.TypedMessage
}
var file_transport_internet_tlsmirror_tlstrafficgen_config_proto_depIdxs = []int32{
	...
	4, // 3: v2ray.core.transport.internet.tlsmirror.tlstrafficgen.Config.security_settings:type_name -> v2ray.core.common.serial.TypedMessage
