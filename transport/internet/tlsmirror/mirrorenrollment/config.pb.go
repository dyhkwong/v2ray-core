...
const file_transport_internet_tlsmirror_mirrorenrollment_config_proto_rawDesc = "" +
	"\n" +
	":transport/internet/tlsmirror/mirrorenrollment/config.proto\x128v2ray.core.transport.internet.tlsmirror.mirrorenrollment\x1a\x19google/protobuf/any.proto\"\xfe\x02\n" +
	"\x06Config\x128\n" +
