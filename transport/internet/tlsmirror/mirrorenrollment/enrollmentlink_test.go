...
func TestLinkRoundTrip(t *testing.T) {
	orig := &serial.TypedMessage{
		Type:  "type.test/example",
...
func TestLinkFromAnyProducesValidDataURL(t *testing.T) {
	orig := &serial.TypedMessage{Type: "type.test/inspect", Value: []byte("inspect-bytes")}
	link, err := LinkFromAny(orig)
	if err != nil {
		t.Fatalf("LinkFromAny failed: %v", err)
	}
...
func TestRejectWrongMIME(t *testing.T) {
	orig := &serial.TypedMessage{Type: "type.test/wrongmime", Value: []byte("x")}
...
func TestRejectMissingBase64Param(t *testing.T) {
	orig := &serial.TypedMessage{Type: "type.test/nobase64", Value: []byte("x")}
	b, _ := proto.Marshal(orig)
	enc := base64.StdEncoding.EncodeToString(b)
...
func TestAcceptExtraParams(t *testing.T) {
	orig := &serial.TypedMessage{Type: "type.test/params", Value: []byte("p")}
	b, _ := proto.Marshal(orig)
	enc := base64.StdEncoding.EncodeToString(b)
...
func TestRejectURLEncodedPayload(t *testing.T) {
	...
	orig := &serial.TypedMessage{Type: "type.test/urlenc", Value: []byte("url-bytes")}
	b, _ := proto.Marshal(orig)
	enc := base64.StdEncoding.EncodeToString(b)
...
func TestCaseSensitiveMIME(t *testing.T) {
	orig := &serial.TypedMessage{Type: "type.test/case", Value: []byte("c")}
	b, _ := proto.Marshal(orig)
	enc := base64.StdEncoding.EncodeToString(b)
...
func TestLargePayloadRoundTrip(t *testing.T) {
	...
	orig := &serial.TypedMessage{Type: "type.test/large", Value: p}
	link, err := LinkFromAny(orig)
	if err != nil {
		t.Fatalf("LinkFromAny failed: %v", err)
	}
...
func TestRejectRawURLEncodingInDataURL(t *testing.T) {
	orig := &serial.TypedMessage{Type: "type.test/rawurl", Value: []byte("raw")}
	b, _ := proto.Marshal(orig)
