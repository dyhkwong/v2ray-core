...
import (
	mirrorenrollment "github.com/v2fly/v2ray-core/v4/transport/internet/tlsmirror/mirrorenrollment"
	tlstrafficgen "github.com/v2fly/v2ray-core/v4/transport/internet/tlsmirror/tlstrafficgen"
...
const file_transport_internet_tlsmirror_server_config_proto_rawDesc = "" +
	"\n" +
	"0transport/internet/tlsmirror/server/config.proto\x12.v2ray.core.transport.internet.tlsmirror.server\x1a7transport/internet/tlsmirror/tlstrafficgen/config.proto\x1a:transport/internet/tlsmirror/mirrorenrollment/config.proto\"\x88\x01\n" +
	"\bTimeSpec\x12)\n" +
	...
	"\aenabled\x18\x01 \x01(\bR\aenabled\"\x84\x06\n" +
	"\x06Config\x12'\n" +
	...
	" \x01(\v2@.v2ray.core.transport.internet.tlsmirror.mirrorenrollment.ConfigR\x14connectionEnrollmentB\xab\x01\n" +
	"2com.v2ray.core.transport.internet.tlsmirror.serverP\x01ZBgithub.com/v2fly/v2ray-core/v4/transport/internet/tlsmirror/server\xaa\x02.V2Ray.Core.Transport.Internet.Tlsmirror.Serverb\x06proto3"
