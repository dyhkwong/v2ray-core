...
const file_transport_internet_tlsmirror_server_config_proto_rawDesc = "" +
	"\n" +
	"0transport/internet/tlsmirror/server/config.proto\x12.v2ray.core.transport.internet.tlsmirror.server\x1a7transport/internet/tlsmirror/tlstrafficgen/config.proto\"\xc9\x02\n" +
	"\x06Config\x12'\n" +
