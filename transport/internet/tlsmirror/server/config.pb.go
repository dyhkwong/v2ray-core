...
const file_transport_internet_tlsmirror_server_config_proto_rawDesc = "" +
	...
	"\aenabled\x18\x01 \x01(\bR\aenabled\"\x8d\x05\n" +
	"\x06Config\x12'\n" +
	...
	"\x17transport_layer_padding\x18\t \x01(\v2E.v2ray.core.transport.internet.tlsmirror.server.TransportLayerPaddingR\x15transportLayerPaddingB\xab\x01\n" +
