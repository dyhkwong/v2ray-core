...
const file_transport_internet_tlsmirror_server_config_proto_rawDesc = "" +
	"\n" +
	"0transport/internet/tlsmirror/server/config.proto\x12.v2ray.core.transport.internet.tlsmirror.server\x1a7transport/internet/tlsmirror/tlstrafficgen/config.proto\"\x89\x03\n" +
	"\x06Config\x12'\n" +
	...
	"primaryKey\x12>\n" +
	"\x1bexplicit_nonce_ciphersuites\x18\a \x03(\rR\x19explicitNonceCiphersuitesB\xab\x01\n" +
