...
const file_transport_internet_kcp_config_proto_rawDesc = "" +
	"\n" +
	"#transport/internet/kcp/config.proto\x12!v2ray.core.transport.internet.kcp\x1a!common/serial/typed_message.proto\"\x1b\n" +
	"\x03MTU\x12\x14\n" +
	...
	"\x04seed\x18\x01 \x01(\tR\x04seed\"\x97\x05\n" +
	"\x06Config\x128\n" +
	...
	"readBuffer\x12K\n" +
	"\rheader_config\x18\b \x01(\v2&.v2ray.core.common.serial.TypedMessageR\fheaderConfig\x12E\n" +
	"\x04seed\x18\n" +
	" \x01(\v21.v2ray.core.transport.internet.kcp.EncryptionSeedR\x04seedJ\x04\b\t\x10\n" +
	"B\x84\x01\n" +
