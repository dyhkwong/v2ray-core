...
const file_transport_internet_tls_utls_config_proto_rawDesc = "" +
	"\n" +
	"(transport/internet/tls/utls/config.proto\x12&v2ray.core.transport.internet.tls.utls\x1a#transport/internet/tls/config.proto\"\xd5\x01\n" +
	"\x06Config\x12H\n" +
	"\n" +
	...
	"\n" +
	"force_alpn\x18\x04 \x01(\x0e22.v2ray.core.transport.internet.tls.utls.ForcedALPNR\tforceAlpn*R\n" +
	"\n" +
	"ForcedALPN\x12&\n" +
	"\"TRANSPORT_PREFERENCE_TAKE_PRIORITY\x10\x00\x12\v\n" +
	"\aNO_ALPN\x10\x01\x12\x0f\n" +
	"\vUTLS_PRESET\x10\x02B\x93\x01\n" +
	"*com.v2ray.core.transport.internet.tls.utlsP\x01Z:github.com/v2fly/v2ray-core/v4/transport/internet/tls/utls\xaa\x02&V2Ray.Core.Transport.Internet.Tls.UTlsb\x06proto3"
