...
const file_transport_internet_http_config_proto_rawDesc = "" +
	"\n" +
	"$transport/internet/http/config.proto\x12\"v2ray.core.transport.internet.http\x1a,transport/internet/headers/http/config.proto\"\xc7\x01\n" +
	"\x06Config\x12\x12\n" +
	...
	"\x15parse_x_forwarded_for\x18\x05 \x01(\bR\x12parseXForwardedForB\x87\x01\n" +
