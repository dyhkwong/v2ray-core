...
type Config struct {
	...
	HopInterval           uint32                 `protobuf:"varint,10,opt,name=hop_interval,json=hopInterval,proto3" json:"hop_interval,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *Config) GetHopInterval() uint32 {
	if x != nil {
...
const file_transport_internet_hysteria2_config_proto_rawDesc = "" +
	...
	"\fhop_interval\x18\n" +
	" \x01(\rR\vhopInterval:\x1a\x82\xb5\x18\x16\n" +
