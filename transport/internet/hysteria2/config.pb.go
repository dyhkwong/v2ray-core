...
const file_transport_internet_hysteria2_config_proto_rawDesc = "" +
	"\n" +
	")transport/internet/hysteria2/config.proto\x12'v2ray.core.transport.internet.hysteria2\"v\n" +
	"\n" +
	"Congestion\x12\x12\n" +
	...
	"\bpassword\x18\x02 \x01(\tR\bpassword\"\xff\x02\n" +
	"\x06Config\x12\x1a\n" +
	...
	"\x1comit_max_datagram_frame_size\x18\xe8\a \x01(\bR\x18omitMaxDatagramFrameSizeB\x96\x01\n" +
	"+com.v2ray.core.transport.internet.hysteria2P\x01Z;github.com/v2fly/v2ray-core/v4/transport/internet/hysteria2\xaa\x02'V2Ray.Core.Transport.Internet.Hysteria2b\x06proto3"
