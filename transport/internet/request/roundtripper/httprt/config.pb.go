...
const file_transport_internet_request_roundtripper_httprt_config_proto_rawDesc = "" +
	"\n" +
	";transport/internet/request/roundtripper/httprt/config.proto\x129v2ray.core.transport.internet.request.roundtripper.httprt\"\xaa\x01\n" +
	"\fClientConfig\x12Y\n" +
	...
	"\x17no_decoding_session_tag\x18\x02 \x01(\bR\x14noDecodingSessionTag\">\n" +
	"\n" +
	"HTTPConfig\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x1c\n" +
	"\turlPrefix\x18\x02 \x01(\tR\turlPrefixB\xcc\x01\n" +
	"=com.v2ray.core.transport.internet.request.roundtripper.httprtP\x01ZMgithub.com/v2fly/v2ray-core/v4/transport/internet/request/roundtripper/httprt\xaa\x029V2Ray.Core.Transport.Internet.Request.Roundtripper.httprtb\x06proto3"
