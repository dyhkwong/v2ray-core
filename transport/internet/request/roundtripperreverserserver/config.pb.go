...
func (x *Config) GetRoundTripperServer() *serial.TypedMessage {
	if x != nil {
...
const file_transport_internet_request_roundtripperreverserserver_config_proto_rawDesc = "" +
	"\n" +
	"Btransport/internet/request/roundtripperreverserserver/config.proto\x12@v2ray.core.transport.internet.request.roundtripperreverserserver\x1a!common/serial/typed_message.proto\"\xa7\x01\n" +
	"\x06Config\x12X\n" +
	...
	"\x11access_passphrase\x18\x04 \x01(\tR\x10accessPassphraseB\xe0\x01\n" +
	"Dcom.v2ray.core.transport.internet.request.roundtripperreverserserverP\x01ZTgithub.com/v2fly/v2ray-core/v4/transport/internet/request/roundtripperreverserserver\xaa\x02?V2Ray.Core.Transport.Internet.Request.RoundtripperReverseServerb\x06proto3"
...
var file_transport_internet_request_roundtripperreverserserver_config_proto_depIdxs = []int32{
	1, // 0: v2ray.core.transport.internet.request.roundtripperreverserserver.Config.round_tripper_server:type_name -> v2ray.core.common.serial.TypedMessage
