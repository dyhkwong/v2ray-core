...
const file_transport_internet_request_assembler_packetconn_packetConn_proto_rawDesc = "" +
	"\n" +
	"@transport/internet/request/assembler/packetconn/packetConn.proto\x12:v2ray.core.transport.internet.request.assembler.packetconn\x1a!common/serial/typed_message.proto\"\xc0\x02\n" +
	"\fClientConfig\x12h\n" +
	"\x1cunderlying_transport_setting\x18\x01 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\x1aunderlyingTransportSetting\x12:\n" +
	...
	"\x18polling_interval_initial\x18\x05 \x01(\x05R\x16pollingIntervalInitial\"\x8c\x03\n" +
	"\fServerConfig\x12h\n" +
	"\x1cunderlying_transport_setting\x18\x01 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\x1aunderlyingTransportSetting\x12:\n" +
	"\x19underlying_transport_name\x18\x02 \x01(\tR\x17underlyingTransportName\x12$\n" +
	...
	"\x15packet_writing_buffer\x18\x06 \x01(\x05R\x13packetWritingBufferB\xcf\x01\n" +
	">com.v2ray.core.transport.internet.request.assembler.packetconnP\x01ZNgithub.com/v2fly/v2ray-core/v4/transport/internet/request/assembler/packetconn\xaa\x02:V2Ray.Core.Transport.Internet.Request.Assembler.Packetconnb\x06proto3"
