...
const file_transport_internet_request_assembler_simple_config_proto_rawDesc = "" +
	"\n" +
	"8transport/internet/request/assembler/simple/config.proto\x126v2ray.core.transport.internet.request.assembler.simple\"\xfa\x02\n" +
	"\fClientConfig\x12$\n" +
	...
	"\x18failed_retry_interval_ms\x18\a \x01(\x05R\x15failedRetryIntervalMs\"4\n" +
	"\fServerConfig\x12$\n" +
	"\x0emax_write_size\x18\x01 \x01(\x05R\fmaxWriteSizeB\xc3\x01\n" +
	":com.v2ray.core.transport.internet.request.assembler.simpleP\x01ZJgithub.com/v2fly/v2ray-core/v4/transport/internet/request/assembler/simple\xaa\x026V2Ray.Core.Transport.Internet.Request.Assembler.Simpleb\x06proto3"
