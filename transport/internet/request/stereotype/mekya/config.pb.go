...
import (
	kcp "github.com/v2fly/v2ray-core/v4/transport/internet/kcp"
...
const file_transport_internet_request_stereotype_mekya_config_proto_rawDesc = "" +
	"\n" +
	"8transport/internet/request/stereotype/mekya/config.proto\x126v2ray.core.transport.internet.request.stereotype.mekya\x1a#transport/internet/kcp/config.proto\"\xe6\x03\n" +
	"\x06Config\x12;\n" +
	...
	"h2PoolSizeB\xc3\x01\n" +
	":com.v2ray.core.transport.internet.request.stereotype.mekyaP\x01ZJgithub.com/v2fly/v2ray-core/v4/transport/internet/request/stereotype/mekya\xaa\x026V2Ray.Core.Transport.Internet.Request.Stereotype.Mekyab\x06proto3"
