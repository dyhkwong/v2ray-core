...
const file_transport_internet_config_proto_rawDesc = "" +
	"\n" +
	"\x1ftransport/internet/config.proto\x12\x1dv2ray.core.transport.internet\x1a!common/serial/typed_message.proto\"\xcc\x01\n" +
	...
	"\rprotocol_name\x18\x03 \x01(\tR\fprotocolName\x12B\n" +
	"\bsettings\x18\x02 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\bsettings\"\xb4\x03\n" +
	"\fStreamConfig\x12P\n" +
	"\bprotocol\x18\x01 \x01(\x0e20.v2ray.core.transport.internet.TransportProtocolB\x02\x18\x01R\bprotocol\x12#\n" +
	...
	"\rsecurity_type\x18\x03 \x01(\tR\fsecurityType\x12S\n" +
	"\x11security_settings\x18\x04 \x03(\v2&.v2ray.core.common.serial.TypedMessageR\x10securitySettings\x12T\n" +
