...
const file_common_protocol_user_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/protocol/user.proto\x12\x1av2ray.core.common.protocol\x1a!common/serial/typed_message.proto\"t\n" +
	"\x04User\x12\x14\n" +
	"\x05level\x18\x01 \x01(\rR\x05level\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12@\n" +
	"\aaccount\x18\x03 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\aaccountBo\n" +
	"\x1ecom.v2ray.core.common.protocolP\x01Z.github.com/v2fly/v2ray-core/v4/common/protocol\xaa\x02\x1aV2Ray.Core.Common.Protocolb\x06proto3"
