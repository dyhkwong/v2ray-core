...
type Config struct {
	...
	Features      map[string]*serial.TypedMessage `protobuf:"bytes,1,rep,name=features,proto3" json:"features,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_common_taggedfeatures_skeleton_proto_rawDesc = "" +
	"\n" +
	"$common/taggedfeatures/skeleton.proto\x12 v2ray.core.common.taggedfeatures\x1a!common/serial/typed_message.proto\"\xc1\x01\n" +
	"\x06Config\x12R\n" +
	"\bfeatures\x18\x01 \x03(\v26.v2ray.core.common.taggedfeatures.Config.FeaturesEntryR\bfeatures\x1ac\n" +
	"\rFeaturesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12<\n" +
	"\x05value\x18\x02 \x01(\v2&.v2ray.core.common.serial.TypedMessageR\x05value:\x028\x01B\x81\x01\n" +
	"$com.v2ray.core.common.taggedfeaturesP\x01Z4github.com/v2fly/v2ray-core/v4/common/taggedfeatures\xaa\x02 V2Ray.Core.Common.Taggedfeaturesb\x06proto3"
