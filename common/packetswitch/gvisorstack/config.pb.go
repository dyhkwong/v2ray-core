...
type TCPListener struct {
	...
	Address       *router.CIDR           `protobuf:"bytes,2,opt,name=address,proto3" json:"address,omitempty"`
...
func (x *TCPListener) GetAddress() *router.CIDR {
	if x != nil {
		return x.Address
	}
	return nil
...
const file_common_packetswitch_gvisorstack_config_proto_rawDesc = "" +
	"\n" +
	",common/packetswitch/gvisorstack/config.proto\x12*v2ray.core.common.packetswitch.gvisorstack\x1a\x17app/router/config.proto\x1a\x1ftransport/internet/config.proto\"j\n" +
	"\vTCPListener\x12\x12\n" +
	"\x04port\x18\x01 \x01(\rR\x04port\x125\n" +
	"\aaddress\x18\x02 \x01(\v2\x1b.v2ray.core.app.router.CIDRR\aaddress\x12\x10\n" +
	"\x03tag\x18\x03 \x01(\tR\x03tag\"\x85\x04\n" +
	"\x06Config\x12\x10\n" +
	"\x03mtu\x18\x02 \x01(\rR\x03mtu\x12\x1d\n" +
	"\n" +
	"user_level\x18\x03 \x01(\rR\tuserLevel\x12-\n" +
	"\x03ips\x18\x06 \x03(\v2\x1b.v2ray.core.app.router.CIDRR\x03ips\x123\n" +
	"\x06routes\x18\a \x03(\v2\x1b.v2ray.core.app.router.CIDRR\x06routes\x126\n" +
	...
	".com.v2ray.core.common.packetswitch.gvisorstackP\x01Z>github.com/v2fly/v2ray-core/v4/common/packetswitch/gvisorstack\xaa\x02*V2Ray.Core.Common.Packetswitch.Gvisorstackb\x06proto3"
...
var file_common_packetswitch_gvisorstack_config_proto_depIdxs = []int32{
	2, // 0: v2ray.core.common.packetswitch.gvisorstack.TCPListener.address:type_name -> v2ray.core.app.router.CIDR
	2, // 1: v2ray.core.common.packetswitch.gvisorstack.Config.ips:type_name -> v2ray.core.app.router.CIDR
	2, // 2: v2ray.core.common.packetswitch.gvisorstack.Config.routes:type_name -> v2ray.core.app.router.CIDR
