...
const file_common_packetswitch_gvisorstack_config_proto_rawDesc = "" +
	"\n" +
	",common/packetswitch/gvisorstack/config.proto\x12*v2ray.core.common.packetswitch.gvisorstack\x1a\x17app/router/config.proto\x1a\x1ftransport/internet/config.proto\"\xa9\x03\n" +
	"\x06Config\x12\x10\n" +
...
var file_common_packetswitch_gvisorstack_config_proto_depIdxs = []int32{
	1, // 0: v2ray.core.common.packetswitch.gvisorstack.Config.ips:type_name -> v2ray.core.app.router.CIDR
	1, // 1: v2ray.core.common.packetswitch.gvisorstack.Config.routes:type_name -> v2ray.core.app.router.CIDR
